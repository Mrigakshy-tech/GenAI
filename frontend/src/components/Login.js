        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 sm:p-12">
          ...
          <div className="mb-8 space-y-3">
            <div className="flex items-start space-x-3">
              ...
              <p className="text-sm text-gray-700">AI-powered medical assistance and diagnosis support</p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="flex-shrink-0 w-6 h-6 bg-purple-100 rounded-full flex items-center justify-center mt-0.5">
                <span className="text-purple-600 text-sm font-bold">✓</span>
              </div>
              <p className="text-sm text-gray-700">Mental health counseling and mood tracking</p>
            </div>
            <div className="flex items-start space-x-3">
          ...
          <button
            onClick={handleLogin}
            className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-4 px-6 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
